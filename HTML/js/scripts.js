...
/*$("#container_top_aside").on("click", function(){
  $("#tournament_table").addClass("hidden");
  $("#best_player").addClass("hidden");
  $("#container_top_header").css("width", "1500")
  $("#container_top_aside").css("width", "500px");
}); */
