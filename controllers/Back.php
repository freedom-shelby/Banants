...
class Back extends \Base{
    ...
    {
        if(\App::instance()->http()->getIpAddress() != '37.157.222.35' and \App::instance()->http()->getIpAddress() != '91.204.190.4' and \App::instance()->http()->getIpAddress() != '127.0.0.1' and \App::instance()->http()->getIpAddress() != '109.75.44.36') die('Error 404');
