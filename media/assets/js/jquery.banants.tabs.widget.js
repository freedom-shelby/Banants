...
(function( $ ) {
    $.fn.banantsTabsWidget = function() {
        ...
        this.each(function(){
            ...
            $(this).find('.widget-pagination .circle').click({obj:$(this)},function(e){
                if($(this).hasClass('active')) return;
                actionTabs(e.data.obj, $(this).index());
            });

            $(this).find('.widget-pagination .wgt-next').click({obj:$(this)},function(e){
        ...
        function actionTabs(obj,activeIndex){
            ...
            obj.find('.widget-pagination .circle').removeClass('active');
            obj.find('.widget-pagination .circle').eq(activeItemIndex).addClass('active');
