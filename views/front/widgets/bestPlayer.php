...
<div class="best_player">
    ...
    <div class="best_player_content">
        <h3><?=__('Henri')?> <?=__('Avagyan')?></h3>
        <div class="best_player_images_wrapper">
            <img src="/uploads/tmp/armenian-flag.jpg" class="sb-back-flag" alt="best_player" />
            <img src="<?= Imagefly::imagePath('/uploads/images/players/57bff63b8a3a3.png', 'w100-q70')?>" class="sb-front-player" alt="best_player" />
            <div class="cylinder"></div>
        </div>
        <div class="best_player_right">
            <div class="best_player_info">
                <span><?=__('Instat Index')?> 198<br> <?=__('Goals')?> 0<br> <?=__('Shots')?> 0</span>
