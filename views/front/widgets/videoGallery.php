    ...
    <div class="content_middle_slider">
        <div class="content_middle_slider_item">
            <div class="content_slider_images content_slider_middle_images">
                <div class="videoimage_wrapper">
                    <a class="various fancybox.iframe" href="http://www.youtube.com/embed/SAuBrEsitUs?autoplay=1">
                        <img class="image1" src="http://img.youtube.com/vi/SAuBrEsitUs/0.jpg" alt="content_slider_middle_images1">
            ...
            <div class="content_slider_images content_slider_middle_images2">
                <div class="videoimage_wrapper">
                    <a class="various fancybox.iframe" href="http://www.youtube.com/embed/unfB8TX26Ek?autoplay=1">
                        <img class="image2" src="http://img.youtube.com/vi/unfB8TX26Ek/0.jpg" alt="content_slider_images" />
                        <img class="videoplayer_icon" src="/media/assets/images/videoplayer_icon.png" alt="videoplayer_icon">
                    </a>
                </div>
            </div><!-- content_middle_slider -->
            <div class="content_slider_images content_slider_big_images">
                <div class="videoimage_wrapper">
                    <a class="various fancybox.iframe" href="http://www.youtube.com/embed/hSl-DpHz8ZI?autoplay=1">
                        <img class="image3" src="http://img.youtube.com/vi/hSl-DpHz8ZI/0.jpg" alt="content_slider_big_images">
                        <img class="videoplayer_icon" src="/media/assets/images/videoplayer_icon.png" alt="videoplayer_icon">
                    </a>
                </div>
            </div><!-- content_middle_slider -->
