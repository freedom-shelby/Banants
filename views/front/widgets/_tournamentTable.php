...
<!--            <div class="tab-1"><div><span>text1</span></div></div>-->
            <div class="tab-1 active"><div><span><?=__('Premier League')?></span></div></div>
            <div class="tab-2"><div><span><?=__('First League')?></span></div></div>
<!--            <div class="tab4"><div><span>text4</span></div></div>-->
        </div>
    </div>
    <div class="widget-body">
        <div class="widget-tabs-body">
<!--            <div class="tab-1">tab desc1</div>-->
            <div class="tab-1">
