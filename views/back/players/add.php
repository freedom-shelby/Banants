                ...
                <div class="group container-fluid">
                    <div class="row col-sm-6 pull-right">
                        ...
                        <div class="form-group col-sm-9">
                            <label for="parentId">Select Country</label>
                            <select name="country">
                                ...
                                <?foreach(Lang::instance()->getLangsExcept(Lang::DEFAULT_LANGUAGE) as $iso => $lang):?>
                                    <div class="tab-pane <?=(Lang::instance()->isPrimary($iso)) ? 'active' : ''?>" id="<?=$iso?>">
                                        <div class="form-group col-sm-13">
                                            ...
                                            <input type="text" name="content[<?=$iso?>][text]" class="form-control" id="text" placeholder="Player Name" <?=((Lang::instance()->isPrimary($iso)) ? ' required' : '')?>>
                                        </div>
                                    </div>
                                <?endforeach?>
                            </div>
